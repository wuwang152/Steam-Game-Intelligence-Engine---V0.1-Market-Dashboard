...
def add_engineered_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    out["genre_count"] = out["Genres"].apply(_count_items)
    out["tag_count"] = out["Tags"].apply(_count_items)
    out["screenshot_count"] = out["Screenshots"].apply(_count_items)
    out["movie_count"] = out["Movies"].apply(_count_items)
